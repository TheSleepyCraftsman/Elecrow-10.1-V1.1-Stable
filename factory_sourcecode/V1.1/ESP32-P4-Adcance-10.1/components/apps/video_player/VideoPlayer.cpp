...
#define APP_VIDEO_FRAME_BUF_SIZE    (BSP_LCD_V_RES * BSP_LCD_H_RES * BSP_LCD_BITS_PER_PIXEL / 8)
#define APP_CACHE_BUF_SIZE          (64 * BSP_LCD_H_RES)
...
void AppVideoPlayer::app_show_ui(void)
{
    ...
    lv_obj_set_size(cont_col, BSP_LCD_H_RES, BSP_LCD_V_RES - 80);
